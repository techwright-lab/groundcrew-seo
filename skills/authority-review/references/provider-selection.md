...
Google Search Console and PageSpeed Insights direct connectors are not currently supported as Groundcrew direct-provider integrations. Do not improvise those API integrations. User-provided exports may still be treated as imported evidence, and TrustGrowth-managed evidence may include comparable measurements when connected.
